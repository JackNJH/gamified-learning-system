...
(17, 7, '0', ''),
(18, 7, '1', ''),
(19, 8, 'Identify the Risk', ''),
(20, 8, 'Evaluate or Rank the Risk', ''),
(21, 8, 'Monitor and Review the risk', ''),
(22, 8, 'Treat the Risk', ''),
(23, 9, 'Analyze the risk', ''),
(24, 9, 'Identify the Risk', ''),
(25, 9, 'Treat the Risk', ''),
(26, 9, 'Monitor and Review the risk', ''),
(27, 10, 'Evaluate or Rank the Risk', ''),
(28, 10, 'Monitor and Review the risk', ''),
(29, 10, 'Treat the Risk', ''),
(30, 10, 'Analyze the risk', ''),
(31, 11, 'Identify the Risk', ''),
(32, 11, 'Monitor and Review the risk', ''),
(33, 11, 'Evaluate or Rank the Risk', ''),
(34, 11, 'Analyze the risk', ''),
(35, 12, 'Evaluate or Rank the Risk', ''),
(36, 12, 'Identify the Risk', ''),
(37, 12, 'Treat the Risk', ''),
(38, 12, 'Monitor and Review the risk', '');
...
(6, 7, '0 NAND 1 = ?', '', 1, 16),
(7, 8, '1 NOR 1 = ?', '', 1, 17),
(8, 15, 'Uncover, recognize and describe risks that might affect your project or its outcomes.<br>Which step is this? ', '', 1, 19),
(9, 15, 'Assess your highest ranked risks and set out a plan to treat or modify these risks to achieve acceptable risk levels.\r\n<br>Which step is this?', '', 1, 25),
(10, 15, 'Once risks are identified you determine the likelihood and consequence of each risk.\r\n<br>Which step is this?', '', 1, 30),
(11, 15, 'Take your Project Risk Register and use it to monitor, track and review risks.\r\n<br>Which step is this?\r\n', '', 1, 32),
(12, 15, 'You evaluate or rank the risk by determining the risk magnitude, which is the combination of likelihood and consequence. \r\n<br>Which step is this?', '', 1, 35);
